...
print(
    "not hard right? we just used a temporary variable z to hold the value of b while we assigned a to b, and then we assigned z (which holds the original value of b) back to a. This way, we successfully swapped the values of a and b."
)
